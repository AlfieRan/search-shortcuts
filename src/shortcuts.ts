...
const InstagramData = {
	...
	searchUrl: 'https://www.instagram.com/explore/tags/%s',
...
const YoutubeData = {
	...
	accountUrl: 'https://youtube.com/@%s',
};
...
const GmailData = {
	...
	accountUrl: 'https://mail.google.com/mail/u/%s/#inbox',
};

const GcalendarData = {
	baseUrl: 'https://calendar.google.com/calendar/u/0/r',
	searchUrl: 'https://calendar.google.com/calendar/u/0/r',
	accountUrl: 'https://calendar.google.com/calendar/u/%s/r',
};
...
export const shortcuts: Record<AvailableShortcuts, ShortcutData> = {
	...
	linkedin: {
		...
		searchUrl: 'https://www.linkedin.com/search/results/all/?keywords=%s',
		accountUrl: 'https://www.linkedin.com/search/results/people/?keywords=%s',
	},
	twt: TwitterData,
	twitter: TwitterData,
